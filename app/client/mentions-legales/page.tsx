      ...
      <article>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>Adresse e-mail : <a href="mailto:support@vercel.com" className="text-gold underline hover:text-gold-700">support@vercel.com</a></li>
            <li>Téléphone : <a href="tel:+19513836898" className="text-gold underline hover:text-gold-700">+1 (951) 383-6898</a></li>
            <li>Site web : <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" className="text-gold underline hover:text-gold-700">https://vercel.com</a></li>
            <li>Contacter Vercel : <a href="https://vercel.com/contact" target="_blank" rel="noopener noreferrer" className="text-gold underline hover:text-gold-700">https://vercel.com/contact</a></li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside mt-2 space-y-1">
            <li>Par e-mail : <a href="mailto:contact@biss-app.fr" className="text-gold underline hover:text-gold-700">contact@biss-app.fr</a></li>
            <li>Par courrier : 14 bis rue Vaucanson, 63100 Clermont-Ferrand</li>
          </ul>
        </section>
        ...
        {/*<section className="mb-6">
          ...
          <p>
            Lors de la navigation sur ce site, des <a href="https://www.cnil.fr/fr/definition/cookie" target="_blank" rel="noopener noreferrer">cookies</a> ou autres traceurs peuvent être installés sur votre terminal &#40;ordinateur, mobile, tablette, ...&#41;, notamment à des fins de fonctionnement, de mesure d&rsquo;audience ou de personnalisation.
          </p>
          <p className="mt-2">
        ...
        <section>
          ...
          <p className="mt-2">
            En cas de litige, une tentative de résolution amiable sera privilégiée. À défaut, les tribunaux français compétents seront seuls habilités.
          </p>
        </section>
